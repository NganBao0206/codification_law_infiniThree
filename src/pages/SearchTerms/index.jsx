...
const SearchTerms = () => {
    ...
    return (
        <>
            <div>
                <h1 className="title">Tìm thuật ngữ trong văn bản</h1>
                <form onSubmit={search}>
                    <div className="w-full mb-4 bg-white py-2 shadow-3xl border-2 border-dark">
                        <div className="px-4 py-2 ">
                            <textarea name="paragraph" value={findTerms.paragraph} onChange={(e) => setfindTerms({ "paragraph": e.target.value })} rows="5" className="w-full p-2 text-lg focus:outline-none" placeholder="Nhập văn bản đề tìm thuật ngữ ..." ></textarea>
                        </div>
