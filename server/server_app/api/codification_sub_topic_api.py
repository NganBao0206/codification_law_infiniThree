...
from server_app.controller.codification_sub_topic_controller import get_legal_document_by_sub_topic_id, get_indexes_sub_topic, get_all_sub_topics

codification_sub_topics_bp = Blueprint('codification_sub_topics', __name__)

codification_sub_topics_bp.route('/', methods=['GET'])(get_all_sub_topics)
