...
def add_message(chat_room_id, content, is_user_message, source=None, legal_document=None):
    ...
    if legal_document is not None:
        msg_legal_doc = MessageLegalDocument(message_id=msg.id, legal_document_id=legal_document.id)
